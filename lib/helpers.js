 ...
 */
Helpers.secureAndNakedRedirect = function(req, res, next) {
	if (Helpers.development) { next(); return }
 ...
 */
Helpers.setCanonicalMeta = function(req, res, next) {
 ...
 */
Helpers.setDisableEmbeddingHeaders = function(req, res, next) {
 ...
 * Adds cache settings.
 */
Helpers.setCachePolicy = function(req, res, next) {
	let age = 0
